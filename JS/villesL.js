document.addEventListener('DOMContentLoaded', function () {
    ...
    var cityLinks = [
        ...
        { name: 'Lauzerte', url: '/laPosteDeLancienneFrance/Villes L/lauzerte/.html' },
        ...
        { name: 'Longwuy', url: '/laPosteDeLancienneFrance/Villes L/Longwuy/Longwuy.html' },
        ...
        { name: 'Loupe', url: '/laPosteDeLancienneFrance/Villes L/Loupe/loupe.html' },
        ...
        { name: 'Luc', url: '/laPosteDeLancienneFrance/Villes L/Luc/Luc.html' },
        { name: 'Lucenay Leveque', url: '/laPosteDeLancienneFrance/Villes L/LucenayLeveque/lucenayLeveque.html' },
        ...
        { name: 'Lude', url: '/laPosteDeLancienneFrance/Villes L/Lude/lude.html' },
