document.addEventListener('DOMContentLoaded', function () {
    ...
    var cityLinks = [
        ...
        { name: 'Alet', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Alet/alet.html' },
        { name: 'Altkirch', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Altkirch/altkirck.html' },
        { name: 'Alzonne', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Alzonne/alzonne.html' },
        { name: 'Amberieu', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Amberieu/amberieuEnBugey.html' },
        { name: 'Ambert', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Ambert/ambert.html' },
        { name: 'Amboise', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Amboise/amboise.html' },
        { name: 'Amiens', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Amiens/amiens.html' },
        { name: 'Ancenis', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Ancenis/ancenis.html' },
        ...
        { name: 'Angouleme', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Angouleme/angoulemes.html' },
        { name: 'Annonay', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Annonay/annonay.html' },
        { name: 'Anse', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Anse/anse.html' },
        { name: 'Antibes', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Antibes/antibes.html' },
        { name: 'Antony', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Antony/antony.html' },
        { name: 'Antrain', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Antrain/antrain.html' },
        { name: 'Apt', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Apt/apt.html' },
        { name: 'Arbois', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Arbois/arbois.html' },
        { name: 'Arbresle', url: '../../../../../.././laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Arbresle/Larbresle.html' },
        { name: 'Arcis', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Arcis/arcis.html' },
        { name: 'Ardes', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Ardes/ardes.html' },
        { name: 'Ardres', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Ardres/ardres.html' },
        { name: 'Argeles', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Argeles/argele.html' },
        { name: 'Argent', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Argent/argent.html' },
        { name: 'Argentan', url: '../../../laPosteDeLancienneFrancelaPosteDeLancienneFrance/Villes A/Argentan/argentan.html' },
        ...
        { name: 'Arnay le Duc', url: '../../../laPosteDeLancienneFrance/Villes A/Arnay/arnay.html' },
        ...
        { name: 'Sommaire Ville A', url: '../../../laPosteDeLancienneFrance/Villes A/sommaireVilleA.html' },
