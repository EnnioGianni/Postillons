...
/* ===========================================
   TITRE : Loader global des scripts
   NOTE : Lance le chargement uniquement
          quand le DOM est prêt
   =========================================== */

if (!window.__globalScriptLoaderDone__) {
  window.__globalScriptLoaderDone__ = true;

  document.addEventListener("DOMContentLoaded", () => {
    const BASE_POSTILLONS = "/Postillons/JS/";
    const BASE_JS = "/JS/";

    const SCRIPT_URLS = [
      BASE_POSTILLONS + "script_global.js",
      BASE_POSTILLONS + "manquantes.js",
      BASE_POSTILLONS + "script.js",
      BASE_POSTILLONS + "Liens.js",
      "https://cdnjs.cloudflare.com/ajax/libs/mathjs/9.5.0/math.min.js",
      BASE_POSTILLONS + "calculatrice.js",

      BASE_JS + "villesA.js", BASE_JS + "villesB.js", BASE_JS + "villesC.js",
      BASE_JS + "villesD.js", BASE_JS + "villesE.js", BASE_JS + "villesF.js",
      BASE_JS + "villesG.js", BASE_JS + "villesH.js", BASE_JS + "villesI.js",
      BASE_JS + "villesJ.js", BASE_JS + "villesK.js", BASE_JS + "villesL.js",
      BASE_JS + "villesM.js", BASE_JS + "villesN.js", BASE_JS + "villesO.js",
      BASE_JS + "villesP.js", BASE_JS + "villesQ.js", BASE_JS + "villesR.js",
      BASE_JS + "villesS.js", BASE_JS + "villesT.js", BASE_JS + "villesU.js",
      BASE_JS + "villesV.js", BASE_JS + "villesW.js", BASE_JS + "villesX.js",
      BASE_JS + "villesY.js", BASE_JS + "villesZ.js",

      BASE_JS + "accueil.js",
      BASE_JS + "cityRedirector.js",

      "https://kit.fontawesome.com/50786edb2e.js"
    ];
    ...
    function loadScript(url) {
      return new Promise((resolve) => {
        ...
        s.src = url;
        s.async = false;
        if (url.includes("kit.fontawesome.com")) s.crossOrigin = "anonymous";
        s.onload = resolve;
        s.onerror = () => {
          console.warn("[Loader] Échec de chargement :", url);
          resolve();
        };
    ...
    SCRIPT_URLS.reduce((p, url) => p.then(() => loadScript(url)), Promise.resolve());
  });
}
