...
.pauseFor(1800)
.changeDelay(20)
.typeString('Artiles sur les Marques postales en...')
.pauseFor(300)
.typeString('<strong>, des origins a nos jours.</strong> !')
.pauseFor(1000)
.deleteChars(26)
.typeString('<span style="color: #27ae60;"><strong> Port dû</span> !')
.pauseFor(1000)
.deleteChars(9)
.typeString('<span style="color: #EA39ff;"> Port Payé</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: midnightblue;"> Déboursé</span> !')
.pauseFor(1000)
.deleteChars(14)
.typeString('<span style="color: #ff6910;"> Manuscrit</span> !')
.start()
...
/*text qui clignotte*/
document.getElementsByTagName("h4")[0].style.fontSize = "20px";
